        ...
        <View style={styles.borderFlatlst}>
          <View
            ...
            <View style={{flexDirection: 'row'}}>
              <Text style={{fontSize: 18, fontWeight: 'bold', color:'#000000'}}>Email: </Text>
            ...
            <View style={{flexDirection: 'row'}}>
              ...
              <Text style={{fontSize: 18, color:'#000000'}}>{item.fullname}</Text>
            </View>
            <View style={{flexDirection: 'row'}}>
              <Text style={{fontSize: 18, fontWeight: 'bold',color:'#000000'}}>Role: </Text>
              <Text style={{fontSize: 18,color:'#000000'}}>{item.role}</Text>
            </View>
          </View>
        </View>
      </TouchableOpacity>
