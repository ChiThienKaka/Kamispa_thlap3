...
export default function EditProfile({navigation}) {
  ...
  return (
    <View style={{flex: 1}}>
      <View style={[{flex: 1, backgroundColor: '#EB4960'}, styles.avatar]}>
      ...
      <View style={{flex: 1, padding: 10}}>
        <View>
          <Text style={{fontSize: 18, marginBottom: 10, fontWeight: 'bold',color:'#000000'}}>
            User name:{' '}
          </Text>
          <TextInput
        ...
        <Button textColor='#ffffff' style={styles.button} mode="contained" onPress={updateInfo}>
          Update
        </Button>
      </View>
    </View>
