      ...
      {service ? (
        <>
          ...
          <View style={{flexDirection: 'row', marginBottom: 10}}>
            <Text style={[styles.txtName,{color:'#000000'}]}>Service name: </Text>
            <Text style={[styles.txtTitle,{color:'#000000'}]}>{service.serviceName}</Text>
          </View>
          <View style={{flexDirection: 'row', marginBottom: 10}}>
            <Text style={[styles.txtName, {color:'#000000'}]}>Price: </Text>
            <Text style={[styles.txtTitle, {color:'#000000'}]}>{service.price}</Text>
          </View>
          {isAdmin && (
            <View style={{flexDirection: 'row', marginBottom: 10}}>
              <Text style={[styles.txtName,{color:'#000000'}]}>Create by: </Text>
              <Text style={[styles.txtTitle,{color:'#000000'}]}>{service.createBy}</Text>
            </View>
          )}
          {isAdmin === false && (
            <View style={{marginBottom: 10}}>
