...
export default function UpdateService({navigation}) {
  ...
  return (
    <View style={{flex: 1, padding: 10}}>
      ...
      <Text style={[styles.text,{color:'#000000'}]}>Service name: </Text>
      <TextInput
      ...
      <Text style={[styles.text,{color:'#000000'}]}>Price: </Text>
      <TextInput
      ...
      <Button textColor='blue' onPress={handleUploadImage}>Upload Image</Button>
      {isAdmin && (
        <Button
          style={styles.button}
          textColor='#ffffff'
