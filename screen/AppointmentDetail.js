      ...
      {appoinment ? (
        <>
          ...
          <View style={{flexDirection: 'row', marginBottom: 10}}>
            <Text style={[styles.txtName,{color:'#000000'}]}>Customer name: </Text>
            <Text style={[styles.txtTitle,{color:'#000000'}]}>{appoinment.customerId}</Text>
          </View>
          <View style={{flexDirection: 'row', marginBottom: 10}}>
            <Text style={[styles.txtName,{color:'#000000'}]}>Seivce name: </Text>
            <Text style={[styles.txtTitle,{color:'#000000'}]}>{appoinment.serviceName}</Text>
          </View>
          <View style={{flexDirection: 'row', marginBottom: 10}}>
            <Text style={[styles.txtName,{color:'#000000'}]}>Price: </Text>
            <Text style={[styles.txtTitle,{color:'#000000'}]}>{appoinment.price}</Text>
          </View>
          <View style={{flexDirection: 'row', marginBottom: 10}}>
            <Text style={[styles.txtName,{color:'#000000'}]}>Date: </Text>
            <Text style={[styles.txtTitle,{color:'#000000'}]}>
