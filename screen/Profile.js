...
export default function Profile({navigation}) {
  ...
  return (
    <View style={styles.container}>
      <View style={[{flex: 1, backgroundColor: 'black'}, styles.avatar]}>
        <Avatar.Image
          style={{
            height: 154,
            width: 154,
      ...
      <View style={styles.containerInfo}>
        <View style={styles.viewTxt}>
          <Icon source="account" color='#000000' size={30} />
          <Text style={[styles.txt,{color:'#000000'}]}>User Name: </Text>
          <Text style={[styles.txtInfo,{color:'#000000'}]}>
            {userLogin !== null && userLogin.fullname}
          </Text>
        </View>
        <View style={styles.viewTxt}>
          <Icon source="email" color='#000000' size={30} />
          <Text style={[styles.txt,{color:'#000000'}]}>Email: </Text>
          <Text style={[styles.txtInfo,{color:'#000000'}]}>
            {userLogin !== null && userLogin.email}
          </Text>
        </View>
        <View style={styles.viewTxt}>
          <Icon source="phone" color='#000000' size={30} />
          <Text style={[styles.txt,{color:'#000000'}]}>Phone: </Text>
          <Text style={[styles.txtInfo,{color:'#000000'}]}>
